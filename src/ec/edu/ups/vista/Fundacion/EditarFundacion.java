 ...
 */
package ec.edu.ups.vista.Fundacion;
...
public class EditarFundacion extends javax.swing.JInternalFrame {
    ...
    public EditarFundacion() {
        ...
        Empresa f = controlador.findByID(1);
        codAux = f.getIdBanco();
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (bander) {
            Empresa u = new Empresa(codAux, txtNombre.getText(), txtDirecion.getText(), BigDecimal.valueOf(Double.parseDouble(txtValor.getText())));
            controlador.edit(u);
