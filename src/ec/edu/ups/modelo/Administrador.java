...
public class Administrador implements Serializable {
    ...
    public Administrador(Integer idAdministrador, Date fechaIngreso, Persona idUsuario) {
    ...
    public String toString() {
        return "ec.edu.ups.modelo.Administrador[ idAdministrador=" + idAdministrador + " ]";
    }
